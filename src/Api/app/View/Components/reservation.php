...
class reservation extends Component
{
	...
	public array $dateTable = []; //: Array<Date>
	public array $timeTable = []; //: Array<string>
	// private $sDate = new Date(new Date().setDate(1)); //: Date
	private $sDate; //: Date
	private $eDate; //: Date
	private array $selectedTimes = []; //: Array<string | null>
	...
	public function __construct()
	{
		$this->dateTable = [];
		$this->timeTable = [];
		$this->sDate = Carbon::today()->startOfMonth();
		$this->eDate = Carbon::today()->endOfMonth();
		$this->selectedTimes = [];
		$this->selectedRooms = [];
		$this->selectedMats = [];
		$this->rooms = [['title' => 'Lokaal 1', 'image' => 'logo.png'], ['title' => 'Lokaal 2', 'image' => 'logo.png'], ['title' => 'Lokaal 3', 'image' => 'logo.png'], ['title' => 'Lokaal 4', 'image' => 'logo.png'], ['title' => 'Lokaal 5', 'image' => 'logo.png'], ['title' => 'Lokaal 6', 'image' => 'logo.png'], ['title' => 'Lokaal 7', 'image' => 'logo.png'], ['title' => 'Lokaal 8', 'image' => 'logo.png'], ['title' => 'Lokaal 9', 'image' => 'logo.png'], ['title' => 'Lokaal 10', 'image' => 'logo.png']];
		$this->mats = [['title' => 'Materiaal 1', 'image' => 'logo.png'], ['title' => 'Materiaal 2', 'image' => 'logo.png'], ['title' => 'Materiaal 3', 'image' => 'logo.png'], ['title' => 'Materiaal 4', 'image' => 'logo.png'], ['title' => 'Materiaal 5', 'image' => 'logo.png'], ['title' => 'Materiaal 6', 'image' => 'logo.png'], ['title' => 'Materiaal 7', 'image' => 'logo.png'], ['title' => 'Materiaal 8', 'image' => 'logo.png'], ['title' => 'Materiaal 9', 'image' => 'logo.png'], ['title' => 'Materiaal 10', 'image' => 'logo.png']];

		$this->createTimeTable('09:00', '17:00', 15);
		$this->createDateTable($this->sDate, $this->eDate);
	}

	private function createTimeTable($startTime, $endTime, $interval)
	{
		$this->timeTable = [];
		...
		while ($start->lte($end)) {
			$this->timeTable[] = $start->format('H:i');
	...
	private function createDateTable($startDate, $endDate)
	{
		$this->dateTable = [];
		...
		while ($start->lte($end)) {
			$this->dateTable[] = $start->format('Y-m-d');
			$start->addDay();
		}
	}
	...
	{
		return view('components.reservation', ['sDate' => $this->sDate, 'eDate' => $this->eDate, 'dateTable' => $this->dateTable, 'timeTable' => $this->timeTable]);
	}
}
